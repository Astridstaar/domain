...
;(function(window) {
        ...
        settings = {
            ...
            tabID:          "chat",
            tabTitle:       "Chat",
            tabText:        "Chat", // most browsers will use the tabID image rather than this text
            tabColor:       "#000000",
...
function updateTab() {
    if (settings.hide_tab) {
        ...
        tab.setAttribute('title', settings.tabTitle);
...
function dropboxURL() {
    var url = settings.url + "/account/dropboxes/" + settings.dropboxID + '?x=1#/dropbox/chat/new';
